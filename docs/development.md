...
- Run `mise run domekeeper:vidot:test` for the automated MoveTo proof. Run `mise run domekeeper:vidot:record` to write `recordings/move.avi` for human visual inspection; recording is not part of the aggregate check.
